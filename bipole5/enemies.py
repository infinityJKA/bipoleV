...
if True:  # Slime Forest Enemies
    ...
    Slimeinoid_A = Enemy(
        ...
        Moves=[
            [equipment.Fire_Breath, 0, 100],
            [equipment.Uppercut, 0, 100],
            [equipment.War_Cry, 0, 100],
        ],
    ...
    Raging_Soul = Enemy(
        ...
        Moves=[
            [equipment.Abyssal_Inferno, 0, 100],
            [equipment.Fire_Breath, 0, 100],
            [equipment.Cursed_Prayer, 0, 100],
        ],
...
if True:  # Ruins of Time Enemies
    Gyrobifastigium_A = Enemy(
        ...
        Moves=[
            [equipment.Three_Space, 0, 100],
            [equipment.Prismatic_Honeycomb, 0, 100],
            [equipment.Geom_Strike, 0, 100],
        ],
    ...
    Dodecahedron_A = Enemy(
        ...
        Moves=[
            [equipment.Convex_Polytope, 0, 100],
            [equipment.Stellation, 0, 100],
            [equipment.Geom_Strike, 0, 100],
        ],
    ...
    Eratosthenesoid_A = Enemy(
        ...
        Moves=[
            [equipment.Polymath, 75, 100],
            [equipment.Global_Projection, 0, 75],
            [equipment.Prime_Sieve, 50, 100],
            [equipment.Geom_Strike, 75, 100],
        ],
        Weakness=["Fire", "Gun"],
    ...
    Nynety = Enemy(
        DisplayName="Nynety",
        Moves=[
            [equipment.Branching, 98, 100],
            [equipment.Dimensional_Reaction, 98, 100],
            [equipment.Nuclear_Fission, 98, 100],
            [equipment.Sine, 75, 97],
            [equipment.Cosine, 75, 97],
            [equipment.Tangent, 25, 75],
            [equipment.Reciprocal, 25, 75],
            [equipment.Fold, 0, 75],
            [equipment.Nontotient, 0, 75],
            [equipment.Solution, 0, 25],
            [equipment.Hyperbolic, 0, 25],
        ],
        Weakness=["Sword", "Gun"],
        Sprite="nynety",
        Level=10,
    ...
    Dyad = Enemy(
        DisplayName="Dyad",
        Moves=[
            [equipment.Pierce, 90, 100],
            [equipment.Holy_Staff, 90, 100],
            [equipment.Inferno, 90, 100],
            [equipment.Plus, 0, 90],
            [equipment.Minus, 50, 90],
            [equipment.Minus_All, 0, 90],
            [equipment.Absorb, 50, 90],
            [equipment.Bullet_Spread, 50, 80],
            [equipment.Silver_Gauntlets, 0, 50],
            [equipment.Slash, 0, 50],
            [equipment.Pierce, 0, 50],
            [equipment.Holy_Staff, 0, 50],
            [equipment.Snipe, 0, 50],
            [equipment.Inferno, 0, 50],
            [equipment.Cryoablate, 0, 50],
            [equipment.Torrent, 0, 50],
            [equipment.Assault_Rifle, 0, 50],
        ],
...
if True:  # Ruins of Time Encounters
    rot1_encounter1 = [
        [Gyrobifastigium_A, Gyrobifastigium_B, Gyrobifastigium_C],
        "Normal",
    ]
    ...
    rot2_encounter3 = [
        [Eratosthenesoid_A, Gyrobifastigium_A, Gyrobifastigium_B],
        "Normal",
    ]
...
if True:  # Bandit Road Enemies
    Crazy_Guy_A = Enemy(
        ...
        Moves=[
            [equipment.Dagger, 75, 100],
            [equipment.Cut, 0, 75],
            [equipment.Stab, 0, 75],
            [equipment.Slash, 0, 25],
        ],
        Weakness=["Lance", "Ice", "Gun"],
        Sprite="crazy_guy",
        Level=7,
    ...
    Gangster_A = Enemy(
        ...
        Moves=[
            [equipment.Fireball, 66, 100],
            [equipment.Freeze, 33, 66],
            [equipment.Bronze_Gauntlets, 66, 100],
            [equipment.Cut, 33, 66],
            [equipment.Sweep, 0, 33],
            [equipment.Flood, 0, 33],
        ],
    ...
    Gangole = Enemy(
        DisplayName="Gangole",
        Moves=[
            [equipment.Pew, 98, 100],
            [equipment.Spray, 98, 100],
            [equipment.Expensive_Cigar, 95, 98],
            [equipment.Pew, 35, 95],
            [equipment.Spray, 35, 95],
            [equipment.Expensive_Cigar, 35, 50],
            [equipment.Spinning_Chair, 0, 35],
            [equipment.Desperation_Shot, 0, 35],
            [equipment.Huffin, 0, 35],
        ],
    ...
    Jeffy_Jimovans = Enemy(
        ...
        Moves=[
            [equipment.Bronze_Gauntlets, 75, 100],
            [equipment.Slash, 0, 75],
            [equipment.Stone_Staff, 0, 75],
            [equipment.Flood, 0, 25],
            [equipment.Long_Bow, 0, 25],
        ],
    ...
    Ersatz_Humphrey = Enemy(
        ...
        Moves=[
            [equipment.Impair, 98, 100],
            [equipment.Mana_Thurst, 98, 100],
            [equipment.Screwdriver_of_Fate, 50, 98],
            [equipment.Life_Transfer, 50, 98],
            [equipment.Mana_Thurst, 0, 50],
            [equipment.Impair, 0, 15],
        ],
...
if True:  # Ricefield Realm Enemies
    Point_Farmer_A = Enemy(
        ...
        Moves=[
            [equipment.Pitchfork, 0, 100],
            [equipment.Irrigation, 0, 100],
            [equipment.Point_Harvest, 0, 99],
            [equipment.Bountiful, 0, 100],
        ],
    ...
    Bonus_Farmer_A = Enemy(
        ...
        Moves=[
            [equipment.Heavy_Punch, 51, 100],
            [equipment.Pocket_Knife, 51, 100],
            [equipment.Speedy_Punch, 0, 50],
            [equipment.Arrgh, 0, 50],
        ],
    ...
    Omega_Point_Farmer_A = Enemy(
        ...
        Moves=[
            [equipment.Fire_Trick, 0, 100],
            [equipment.Douse, 0, 100],
            [equipment.Ice_Cube, 0, 100],
            [equipment.Recover, 0, 100],
            [equipment.Bet, 51, 100],
            [equipment.Raise, 0, 50],
        ],
    ...
    Hyper_Final_Assassin_Ultra = Enemy(
        ...
        Moves=[
            [equipment.Await, 99, 100],
            [equipment.Burst_Slash_X, 85, 99],
            [equipment.Burst_Slash_Y, 85, 99],
            [equipment.Await, 65, 85],
            [equipment.Umbral_Vociferation, 65, 85],
            [equipment.Burst_Slash_Z, 0, 65],
            [equipment.Burst_Slash_A, 0, 65],
        ],
...
if True:  # Metalimnion Enemies
    ...
    Picky_Jimmy = Enemy(
        ...
        Moves=[
            [equipment.Comically_Large_Pick, 50, 100],
            [equipment.Epic_Guitar_Riff, 0, 50],
        ],
    ...
    New_Link_No_Shield = Enemy(
        DisplayName="The New Link",
        Moves=[
            [equipment.Slash, 90, 100],
            [equipment.Pierce, 90, 100],
            [equipment.Snipe, 90, 100],
            [equipment.Holy_Staff, 90, 100],
            [equipment.Torrent, 90, 100],
            [equipment.Soul_Banishment, 80, 90],
            [equipment.Plus, 45, 90],
            [equipment.Minus, 45, 90],
            [equipment.Drain, 45, 90],
            [equipment.Revitalize, 45, 79],
            [equipment.Bombard, 0, 80],
            [equipment.Soul_Banishment, 20, 44],
            [equipment.Gigaboost, 0, 50],
        ],
...
if True:  # Labyrinth of Binding Enemies:
    ...
    Skel_Floater_A = Enemy(
        ...
        Moves=[
            [equipment.Inferno, 0, 100],
            [equipment.Skull_Flame, 0, 100],
            [equipment.Skel_Boost, 0, 100],
            [equipment.Healing_Aura, 0, 75],
        ],
    ...
    Skulsorer_A = Enemy(
        ...
        Moves=[
            [equipment.Cryoablate, 0, 100],
            [equipment.Skull_Frost, 0, 100],
            [equipment.Necrobsorber, 0, 100],
            [equipment.Healing_Aura, 0, 75],
        ],
    ...
    Eidola = Enemy(
        DisplayName="Eidola",
        Moves=[
            [equipment.Skull_Flame, 50, 100],
            [equipment.Skull_Frost, 50, 100],
            [equipment.Necrobsorber, 50, 100],
            [equipment.Soul_Banishment, 0, 50],
        ],
    ...
    Raidiole = Enemy(
        ...
        Moves=[
            [equipment.Piercing_Shot, 75, 100],
            [equipment.Spikey_Spray, 75, 100],
            [equipment.Incite_Fear, 0, 90],
            [equipment.Metaphysical_Bullet, 0, 75],
...
if True:  # Alter Realm Enemies:
    Aqua = Enemy(
        ...
        Moves=[
            [equipment.Torrent, 0, 100],
            [equipment.Slash, 0, 100],
            [equipment.Flood, 0, 100],
        ],
    ...
    Lead = Enemy(
        ...
        Moves=[
            [equipment.Fire_Card, 0, 100],
            [equipment.Water_Card, 0, 100],
            [equipment.Ice_Card, 0, 100],
        ],
    ...
    Neville_ZX = Enemy(
        DisplayName="Mirrored A",
        Moves=[
            [equipment.Hot_Glue_Gun, 0, 100],
            [equipment.Nolmech_Blast, 0, 100],
            [equipment.ZXer, 0, 100],
        ],
    ...
    Erif = Enemy(
        DisplayName="Mirrored C",
        Moves=[
            [equipment.Flame_Blade, 0, 100],
            [equipment.Fire_Blast, 0, 100],
            [equipment.Recover, 0, 100],
        ],
    ...
    Egam = Enemy(
        DisplayName="Mirrored A",
        Moves=[
            [equipment.Attack_Shield, 0, 100],
            [equipment.Magic_Shield, 0, 100],
            [equipment.Fire_Blast, 0, 100],
            [equipment.Congeal, 0, 100],
            [equipment.Hydro, 0, 100],
        ],
    ...
    Infinity = Enemy(
        DisplayName="Mirrored C",
        Moves=[
            [equipment.Infinite_Blade, 50, 100],
            [equipment.Infinite_Blade_X, 0, 100],
            [equipment.Infinite_Blade_Y, 0, 50],
        ],
