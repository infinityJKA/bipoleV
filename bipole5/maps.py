...
Bieace_Castle_Town = [
    ...
    [],
    0,
    [100.00, ["Neutral", 1], [95.23, 94.21, 93.43, 95.32, 98.56]],
    "brown",
    "safe",
]
...
Slime_Forest = [
    ...
    "slime_forest",
    True,
    [enemies.sf1_encounter1, enemies.sf1_encounter2, enemies.sf1_encounter3],
    5,
    [0, ["no eco", 0], [0, 0, 0, 0, 0]],
    "brown",
    "dangerous",
...
Slime_Forest2 = [
    ...
    "slime_forest2",
    True,
    [enemies.sf2_encounter1, enemies.sf2_encounter2, enemies.sf2_encounter3],
    5,
    [0, ["no eco", 0], [0, 0, 0, 0, 0]],
    "dark_green",
    "dangerous",
...
Ruins_of_Time1 = [
    ...
    "ruins_of_time1",
    True,
    [enemies.rot1_encounter1, enemies.rot1_encounter2],
    2,
    [100, ["Neutral", 1], [95.23, 94.21, 93.43, 95.32, 98.56]],
    "green",
    "dangerous",
]
...
Ruins_of_Time2 = [
    ...
    "ruins_of_time2",
    True,
    [enemies.rot2_encounter1, enemies.rot2_encounter2, enemies.rot2_encounter3],
    2,
    [0, ["no eco", 0], [0, 0, 0, 0, 0]],
    "brown",
    "dangerous",
...
Metalimnion = [
    ...
    [],
    0,
    [100.00, ["Rising", 1], [95.23, 94.21, 93.43, 95.32, 98.56]],
    "brown",
    "safe",
]
...
Ricefield_Realm = [
    ...
    "ricefield_realm",
    True,
    [enemies.rr_encounter1, enemies.rr_encounter2, enemies.rr_encounter3],
    2,
    [0, ["no eco", 0], [0, 0, 0, 0, 0]],
    "brown",
    "dangerous",
...
Labyrinth_of_Binding_A1 = [
    "Labyrinth of Binding A1",
    labyrinth_of_binding_a1_map,
    "stone",
    "magic2",
    "labyrinth_of_binding_a1",
    True,
    [enemies.lob_encounter1, enemies.lob_encounter2],
    2,
    [0, ["no eco", 0], [0, 0, 0, 0, 0]],
    "magic2",
    "dangerous",
...
Labyrinth_of_Binding_A2 = [
    "Labyrinth of Binding A2",
    labyrinth_of_binding_a2_map,
    "stone",
    "magic2",
    "labyrinth_of_binding_a2",
...
Labyrinth_of_Binding_A3 = [
    "Labyrinth of Binding A3",
    labyrinth_of_binding_a3_map,
    "stone",
    "magic2",
    "labyrinth_of_binding_a3",
...
Alter_Realm = [
    ...
    "alter_realm",
    True,
    [enemies.ar_encounter1, enemies.ar_encounter2, enemies.ar_encounter3],
    3,
    [0, ["no eco", 0], [0, 0, 0, 0, 0]],
    "alter2",
    "dangerous",
