...
Passway_Village = ["Passway Village", passway_village_map, "stone", "green","passway_village",False,[],0,[100.00,["Neutral",1],[95.23,94.21,93.43,95.32,98.56]],"green"]
List_of_All_Locations.append(Bieace_Castle_Town)

Ruins_of_Time1 = ["Ruins of Time A1", ruins_of_tine_map1, "stone", "ruins","ruins_of_time1",True,[enemies.sf2_encounter1],10,[0,["no eco",0],[0,0,0,0,0]],"green"]
List_of_All_Locations.append(Slime_Forest2)
