...
Alter_Realm = ["Alter Realm", alter_realm_a1_map, "stone", "dark_green","slime_forest",True,[enemies.ar_encounter1,enemies.ar_encounter2,enemies.ar_encounter3],5,[0,["no eco",0],[0,0,0,0,0]],"brown","dangerous"]
List_of_All_Locations.append(Slime_Forest)
