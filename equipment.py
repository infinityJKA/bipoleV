...
class Key_Item:
    def __init__(self, Display_Name="DISPLAY NAME", sprite="", text_file=""):
        self.DisplayName = Display_Name
        self.sprite = sprite
...
if True:  # Key Items
    test_key = Key_Item(Display_Name="test key", sprite="nwap", text_file="test_item")

    sussy_device = Key_Item(
        Display_Name="Sussy Device", sprite="sussy_device", text_file="sussy_device"
    )

    humphrey_lore = Key_Item(
        Display_Name="HUMPHREY LORE", sprite="humphrey_lore", text_file="humphrey_lore"
    )
    ...
    ecochecker = Key_Item(
        Display_Name="Eco-Checker", sprite="ecochecker", text_file="ecochecker"
    )
    ...
    ricefield_key = Key_Item(
        Display_Name="Ricefield Key", sprite="ricefield_key", text_file="ricefield_key"
    )

    useless_award = Key_Item(
        Display_Name="Useless Award", sprite="useless_award", text_file="useless_award"
    )

    card1 = Key_Item(Display_Name="Card 1", sprite="card1", text_file="card1")

    card2 = Key_Item(Display_Name="Card 2", sprite="card2", text_file="card2")

    neville_coin = Key_Item(
        Display_Name="Neville Coin", sprite="neville_coin", text_file="neville_coin"
    )

    virginity_hat = Key_Item(
        Display_Name="Virginity Hat", sprite="virginity_hat", text_file="virginity_hat"
    )
    ...
    alter_key = Key_Item(
        Display_Name="Alter Key", sprite="ricefield_key", text_file="alter_key"
    )

    surface_key = Key_Item(
        Display_Name="Surface Key", sprite="ricefield_key", text_file="surface_key"
    )
    ...
    letter = Key_Item(
        Display_Name="Mysterious Letter", sprite="letter", text_file="letter"
    )
